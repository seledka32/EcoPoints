...
export function SignUpForm() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to email verification (no auto-login until verified)
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
          ...
          <p className="mb-6 text-gray-400">Создайте аккаунт и начните копить баллы</p>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white mb-4 py-6"
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0f0f0f] px-2 text-gray-500">или</span>
            </div>
          </div>
